...
public class EditChannelDialog extends AlertDialog implements
	...
	private void initData() {
		mUri = Uri.withAppendedPath(Channels.CONTENT_URI,
				String.valueOf(mPreset));
		...
		if (cursor != null) {
			...
			final String freqString = FMUtil
					.formatFrequency(context, frequency);
