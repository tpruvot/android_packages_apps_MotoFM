...
public class FMClearChannel extends ListActivity implements
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(Menu.NONE, UNSELECT_ALL_ID, Menu.FIRST + 2,
				R.string.unselect_all).setIcon(R.drawable.ic_menu_unselect_all);
		return true;
	}
	...
	private void doClear() {
		...
		getContentResolver().update(Channels.CONTENT_URI, cv, sb.toString(),
				null);
